...
import { useAuth, useMonthlyStats } from '../lib/hooks';
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <h1 className="text-2xl font-bold text-gray-900">LINEレシート家計簿</h1>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white rounded-xl shadow-sm p-6 border">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">今月の支出総額</h3>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">支出回数</h3>
                <p className="text-3xl font-bold text-blue-600">
                  {stats?.expenseCount || 0}回
                </p>
              </div>
              
              <div className="bg-white rounded-xl shadow-sm p-6 border">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">1日平均</h3>
                <p className="text-3xl font-bold text-green-600">
                  ¥{stats ? Math.round(stats.totalAmount / currentDate.daysInMonth()).toLocaleString() : 0}
                </p>
              </div>
            </div>
            ...
            {stats && stats.totalAmount > 0 ? (
              ...
              <div className="bg-white rounded-xl shadow-sm p-12 border text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">まだ支出データがありません</h3>
