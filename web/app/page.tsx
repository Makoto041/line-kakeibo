    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        ...
        <div className="glass-card rounded-3xl p-8 text-center max-w-sm">
          <div className="w-12 h-12 rounded-full bg-red-100/80 flex items-center justify-center mx-auto mb-4">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="pressable glass-card w-10 h-10 flex items-center justify-center rounded-full text-gray-500 disabled:opacity-30"
          >
        ...
        {statsLoading ? (
          ...
          <>
            {/* Hero total card with specular highlight */}
            <div className="glass-hero rounded-3xl p-6">
              <p className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">今月の支出</p>
              <p className="text-4xl font-bold text-gray-900 tabular-nums tracking-tight">
                ¥{(stats?.totalAmount || 0).toLocaleString()}
              </p>
              <div className="flex items-center gap-4 mt-3 text-sm text-gray-500">
                <span className="glass-inset rounded-full px-3 py-1">{stats?.expenseCount || 0}件</span>
                <span className="glass-inset rounded-full px-3 py-1">日平均 ¥{dailyAvg.toLocaleString()}</span>
              </div>
            </div>
            ...
            {stats && stats.totalAmount > 0 ? (
              <>
                ...
                <div className="grid grid-cols-3 gap-3">
                  {topCategories.map(([category, amount]) => (
                    <div key={category} className="glass-card rounded-2xl p-3.5 text-center">
                ...
                <Link
                  ...
                  className="pressable glass-card flex items-center justify-between rounded-3xl p-4 hover:bg-white/60 transition-colors"
                >
                  <div className="flex items-center gap-3">
                    <div className="glass-accent w-10 h-10 rounded-full flex items-center justify-center">
              ...
              <div className="glass-card rounded-3xl p-8 text-center">
                <div className="glass-accent w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <div className="glass-inset rounded-2xl p-4 text-left space-y-2 max-w-xs mx-auto">
